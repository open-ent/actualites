...
import { ButtonV3, Flex, useBreakpoint } from '@edifice.io/react';
    ...
    <>
      ...
      >
              ...
              <Select
                ...
                labelRender={(props) => (
                  <Flex align="center" gap="8">
                    <ThreadIcon
                      thread={threads.find((t) => t._id === props.value)}
                      iconSize={iconSize}
                    />
                    <div>{props.label}</div>
                  </Flex>
        ...
        <Flex
          ...
          gap="12"
        >
          <ButtonV3 color="primary" variant="ghost" startIcon={<IconSave />}>
