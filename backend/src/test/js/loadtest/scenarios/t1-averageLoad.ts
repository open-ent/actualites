...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{type:create_info}': [],
  ...
  scenarios: {
    ...
    ramp_up_create_info: {
      ...
      startVUs: 0,
      stages: [
        { duration: '30s', target: Math.floor(constantVu / 30) }, // montée progressive
        { duration: duration, target: Math.floor(constantVu / 30) }, // plateau stable
        { duration: '10s', target: 0 }, // descente propre (facultatif)
      ],
      gracefulRampDown: '10s',
    },
