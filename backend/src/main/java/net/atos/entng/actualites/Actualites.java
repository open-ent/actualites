...
public class Actualites extends BaseServer {
	...
	public void start(Promise<Void> startPromise) throws Exception {
		...
		InfoTransformerService infoService = new InfoTransformerServiceImpl(contentTransformerClient);
		...
		infoController.setInfoTransformerService(infoService);
		infoController.setInfoService(new InfoServiceSqlImpl());
